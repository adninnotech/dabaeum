...
class OpenApiContractControllerTest {
    ...
    @Test
    void servesCanonicalOpenApiContractForLocalProfile() throws Exception {
    ...
    @Test
    void servesSwaggerConfigPointingAtCanonicalContract() throws Exception {
        mockMvc.perform(get("/openapi/swagger-config"))
            .andExpect(status().isOk())
            .andExpect(content().contentTypeCompatibleWith(
            ...
            .andExpect(jsonPath("$.validatorUrl").value(""));
    }
}
